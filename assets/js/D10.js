...
skills.push("JavaScript", "da eliminare");
console.log(me);
...
console.log(isThisAnEmail("dangelodavide02@gmail.com"));
...
function isTodayMyBirthday(birthdayDate) {
  ...
  if (todayMonth === birthdayMonth && todayDay === birthdayDay) {
    ...
    return `il tuo compleanno è il ${birthdayDay} ${birthdayMonth + 1}`;
  }
}
console.log(isTodayMyBirthday("2025-11-06"));
...
const user = {
  ...
  age: 22,
  city: "Bracciano",
  hobbies: ["motociclismo", "programmazione", "videogiochi"],
  isStudent: true,
};
